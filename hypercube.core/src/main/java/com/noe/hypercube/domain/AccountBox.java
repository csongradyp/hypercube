...
public class AccountBox<ACCOUNT_TYPE extends Account, ENTITY_TYPE extends FileEntity, MAPPING_TYPE extends MappingEntity> {
    ...
    private final DirectoryMapper<ACCOUNT_TYPE, MAPPING_TYPE> mapper;
    private FileEntityFactory<ACCOUNT_TYPE, ENTITY_TYPE> entityFactory;

    public AccountBox(IClient<ACCOUNT_TYPE, ENTITY_TYPE> client, DirectoryMapper<ACCOUNT_TYPE, MAPPING_TYPE> mapper, FileEntityFactory<ACCOUNT_TYPE, ENTITY_TYPE> entityFactory) {
    ...
    private void validate(IClient<ACCOUNT_TYPE, ENTITY_TYPE> client, DirectoryMapper<ACCOUNT_TYPE, MAPPING_TYPE> mapper, FileEntityFactory<ACCOUNT_TYPE, ENTITY_TYPE> entityFactory) {
        // TODO validate types
    }
    ...
    public DirectoryMapper<ACCOUNT_TYPE, MAPPING_TYPE> getMapper() {
        return mapper;
    }
