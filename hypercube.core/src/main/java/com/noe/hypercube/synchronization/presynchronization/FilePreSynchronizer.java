...
public class FilePreSynchronizer implements IFilePreSynchronizer {

    // TODO make presynchronizer to synch a single folder.
    private static final Logger LOG = LoggerFactory.getLogger(FilePreSynchronizer.class);

    private final FileAlterationListener fileListener;
    private final Collection<? extends FileEntity> mappedFiles;

    public FilePreSynchronizer(final LocalFileListener fileListener, final Collection<FileEntity> mappedFiles) {
