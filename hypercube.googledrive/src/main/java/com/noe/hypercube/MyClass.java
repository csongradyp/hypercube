...
//        throw new UnsupportedOperationException();
        final Credential credentials = new Credential(null);
        final Properties properties = new Properties();
        try {
            properties.load(MyClass.class.getResourceAsStream("auth.properties"));
            credentials.setAccessToken((String) properties.get("google.token.access"));
            credentials.setRefreshToken((String) properties.get("google.token.refresh"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        return credentials;
    ...
    static void storeCredentials(String userId, Credential credentials) {
        ...
        try {
            properties.load(MyClass.class.getResourceAsStream("auth.properties"));
            properties.put("google.token.access", credentials.getAccessToken());
            properties.put("google.token.refresh", credentials.getRefreshToken());
            properties.store(FileUtils.openOutputStream(new File("auth.properties")), "");
        } catch (IOException e) {
            e.printStackTrace();
        }
//        throw new UnsupportedOperationException();
    ...
    static GoogleAuthorizationCodeFlow getFlow() throws IOException {
        if (flow == null) {
            ...
            GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(jsonFactory, new FileReader(CLIENTSECRETS_LOCATION));
...
//    }
    ...
    public static Credential getCredentials(String emailAddress, String authorizationCode, String state) throws CodeExchangeException, NoRefreshTokenException, IOException {
        // No refresh token has been retrieved.
        try {
...
//        return new Drive.Builder(httpTransport, jsonFactory, getCredentials()).build();
//    }
